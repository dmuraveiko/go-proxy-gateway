...
Каждый логический Proxy имеет `proxy_id` и одну PostgreSQL. Несколько физических
экземпляров одного `proxy_id` делят эту БД и NATS queue group; leases/locks исключают
параллельное выполнение одной операции. Разные `proxy_id` не делят БД.
